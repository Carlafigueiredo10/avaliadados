...
st.markdown(
    ...
    "- **Letramento e a conquista da consciência** — Lélia ensinava que "
    "assumir a própria identidade e reconhecer as estruturas sociais era uma "
    '"conquista", um processo ativo de educação. A agente Lélia herda essa '
    "vocação pedagógica: não apenas emite pareceres, mas promove o letramento "
    "em inteligência artificial, ajudando o servidor público a compreender "
    "criticamente a tecnologia que utiliza e a tornar o Estado mais consciente "
